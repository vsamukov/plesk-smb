...
//GENERATE ACTIVATION CODES LOCALLY

exec("sh generate_keys.sh");
$keys=file_get_contents("activationcodes.txt");
echo "<pre>";
echo $keys;
echo "</pre>";
echo "<br>";
...
$CMD="wget http://provider.nextgen/activationcodes.txt;wget http://provider.nextgen/install_keys.sh";
